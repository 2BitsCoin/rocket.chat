...
RocketChat.settings.addGroup 'Email', ->
	@section 'Header and Footer', ->
		...
		@add 'Email_Footer', '</td></tr></table></td></tr><tr><td border="0" cellspacing="0" cellpadding="0" width="100%" style="font-family: Helvetica,Arial,sans-serif; max-width: 800px; margin: 0 auto; padding: 1.5em; text-align: center; font-size: 8pt; color: #999;"></td></tr></table></td></tr></table>', {
			type: 'code',
			code: 'text/html',
			multiline: true,
			i18nLabel: 'Footer'
...
RocketChat.settings.addGroup 'Layout', ->
	...
	@section 'Content', ->
		...
		@add 'Layout_Home_Body', 'Welcome to Chat <br> Go to APP SETTINGS -> Layout to customize this intro.', { type: 'code', code: 'text/html', multiline: true, public: true }
