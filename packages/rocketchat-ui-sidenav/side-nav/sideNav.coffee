Template.sideNav.helpers
	...
	footer: ->
		...
		else if sDolphinUrl.length and 0 == sTridentUrl.length and 0 == sUnaUrl.length
		...
		else if sTridentUrl.length and 0 == sDolphinUrl.length and 0 == sUnaUrl.length
		...
		else if sUnaUrl.length and 0 == sDolphinUrl.length and 0 == sTridentUrl.length
			'<div style="height:50%; width:100%; position:relative;"><a style="display:block; text-align:center; width:100%; position:absolute; bottom:0; right:0; line-height:0;" href="' + sUnaUrl + '" target="_blank">' + t("Goto_main_site") + '</a></div>'
