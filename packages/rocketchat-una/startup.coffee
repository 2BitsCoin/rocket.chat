RocketChat.settings.add 'API_UNA_URL', '', { type: 'string', group: 'OAuth', public: true, section: 'UNA' }
RocketChat.settings.add 'Accounts_OAuth_UNA', false, { type: 'boolean', group: 'OAuth', section: 'UNA' }
RocketChat.settings.add 'Accounts_OAuth_UNA_id', '', { type: 'string', group: 'OAuth', section: 'UNA' }
RocketChat.settings.add 'Accounts_OAuth_UNA_secret', '', { type: 'string', group: 'OAuth', section: 'UNA' }
